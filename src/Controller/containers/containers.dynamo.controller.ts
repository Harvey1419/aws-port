...
import { createContainerService, getContainerService, deleteContainerService, newContainerStatus } from "../../Services/containers/containers.service";
...
ContainersRouter.post('/createContainer', containerValidations(containerKeysValidator),  createContainerService)
                ...
                .post('/newStatus/:numero_do/:numero_contenedor', newContainerStatus)
